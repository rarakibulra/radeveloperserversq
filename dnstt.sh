...
RESPONSE = 'HTTP/1.1 101 <font color="red">RADeveloper</font>\r\n\r\nContent-Length: 104857600000\r\n\r\n'
...
wget -O /usr/bin/badvpn-udpgw "https://github.com/johnberic/yaki/raw/main/badvpn-udpgw64"
chmod +x /usr/bin/badvpn-udpgw
ps x | grep 'udpvpn' | grep -v 'grep' || screen -dmS udpvpn /usr/bin/badvpn-udpgw --listen-addr 127.0.0.1:7300 --max-clients 10000 --max-connections-for-client 10 --client-socket-sndbuf 10000

wget -O autodns "https://raw.githubusercontent.com/johnberic/nana/main/autodns" && chmod +x autodns && sed -i -e 's/\r$//' ~/autodns && ./autodns
...
if nc -z localhost 8030; then
    echo "WebSocket is running"
else
    echo "Starting WebSocket"
    screen -dmS websocket python /usr/local/sbin/websocket.py 8030
fi
...
<div class="jumbotron">
<h1 class="display-3 text-center fn-color">TK</h1>
